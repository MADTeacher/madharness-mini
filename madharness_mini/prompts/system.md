...
- Use `write_file` or `apply_patch` for edits inside the workspace.
...
- Prefer project-documented commands from README, AGENTS.md, pyproject, package files, or nearby tests.
